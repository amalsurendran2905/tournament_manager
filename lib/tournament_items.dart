...
import 'package:tournament_app/teamsView.dart';
...
class UserTournamentItem extends StatefulWidget {
  UserTournamentItem({
    super.key,
  });

  @override
  State<UserTournamentItem> createState() => _ViewpageState();
}

class _ViewpageState extends State<UserTournamentItem> {
